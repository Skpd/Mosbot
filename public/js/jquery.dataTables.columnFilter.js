...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateInput(oTable, regex, smart, bIsNumber, iFilterLength, iMaxLenght) {
            ...
            var input = $('<input type="text" placeholder="' + label + '" class="' + search_init + sCSSClass + '" value="' + inputvalue + '"/>');
            ...
            if (bIsNumber && !oTable.fnSettings().oFeatures.bServerSide) {
                ...
                input.keyup(function() {
                    ...
                    to = setTimeout($.proxy(function () {
                        ...
                        fnOnFiltered();
                    }, this), properties.iFilteringDelay);
                });
            }
...
//            th.html('<label for="' + sFromId + '">' + _fnRangeLabelPart(0) + '</label>');
            th.html('');

            var from = $('<input type="text" placeholder="' + _fnRangeLabelPart(0) + '" class="date_range_filter" id="' + sFromId + '" rel="' + i + '"/>');
            from.datepicker();
            th.append(from);

//            th.append('<label for="' + sToId + '">' + _fnRangeLabelPart(1) + '</label>');

            var to = $('<input type="text" placeholder="' + _fnRangeLabelPart(1) + '" class="date_range_filter" id="' + sToId + '" rel="' + i + '"/>');
            th.append(to);
            th.append(_fnRangeLabelPart(2));
